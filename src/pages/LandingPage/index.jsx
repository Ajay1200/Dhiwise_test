    ...
    <>
      <div className="bg-white_A700 flex flex-col font-markoone sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        <div className="flex flex-col items-start justify-start w-full">
          <LandingPageHeader
            className="bg-white_A700 flex gap-2 h-20 md:h-auto items-center justify-between md:px-5 px-[120px] py-[19px] w-full"
            onClick={() => navigate("/blogdetails")}
            onClick1={() => navigate("/listingmapview")}
            onClick2={() => navigate("/agentlist")}
            onClick3={() => navigate("/listing")}
            onClick4={() => navigate("/blogpage")}
            onClick5={() => googleSignIn()}
          />
                ...
                <div className="bg-white_A700 flex flex-col items-start justify-start p-6 sm:px-5 rounded-[16px] w-full">
                  <div className="flex flex-col gap-[38px] items-center justify-start w-full">
                    <div className="flex sm:flex-col flex-row gap-4 items-center justify-center w-full">
                      <Button
                        className="common-pointer bg-gray_900 cursor-pointer flex-1 font-bold sm:px-5 px-[31px] py-4 rounded-[10px] text-center text-lg text-white_A700 w-full"
                        onClick={() => navigate("/propertydetails")}
                      >
                        Buy
                      </Button>
                      <Button
                        className="common-pointer bg-gray_300 cursor-pointer flex-1 font-bold sm:px-5 px-[31px] py-4 rounded-[10px] text-center text-gray_900 text-lg w-full"
